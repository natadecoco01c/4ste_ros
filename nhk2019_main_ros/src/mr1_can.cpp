...
//	static constexpr uint16_t id_launcherCmd = 0x301;
	...
	static constexpr uint16_t id_base_wheel0_cmd = 0xff;
	static constexpr uint16_t id_base_wheel0_cmd_vel = 0xf01;
	static constexpr uint16_t id_base_wheel1_cmd = 0x4a2;
	static constexpr uint16_t id_base_wheel1_cmd_vel = 0xf02;
	static constexpr uint16_t id_base_wheel2_cmd = 0x4a8;
	static constexpr uint16_t id_base_wheel2_cmd_vel = 0xf03;
	...
	static constexpr uint16_t id_base_steer3_cmd = 0x4f8;
	static constexpr uint16_t id_base_steer3_cmd_pos = 0xf08;
	static constexpr uint16_t id_base_steer3_status = 0x4fa;
